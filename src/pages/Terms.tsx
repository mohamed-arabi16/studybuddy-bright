      ...
      <div className="container max-w-3xl py-12 px-4">
        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
          ...
          <section className="space-y-4">
            ...
            <p>
              {language === "ar"
                ? "باستخدامك لمنصة StudyBuddy، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، يرجى عدم استخدام المنصة."
                : "By using StudyBuddy, you agree to be bound by these terms and conditions. If you do not agree to any part of these terms, please do not use the platform."}
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              {language === "ar"
                ? "جميع المحتويات والعلامات التجارية والملكية الفكرية على المنصة مملوكة لـ StudyBuddy أو مرخصيها. لا يجوز نسخ أو تعديل أو توزيع أي محتوى دون إذن كتابي مسبق."
                : "All content, trademarks, and intellectual property on the platform are owned by StudyBuddy or its licensors. No content may be copied, modified, or distributed without prior written permission."}
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <p>
              {language === "ar"
                ? "إذا كان لديك أي أسئلة حول هذه الشروط، يرجى التواصل معنا عبر البريد الإلكتروني: mohamed.khair@qobouli.com"
                : "If you have any questions about these terms, please contact us at: mohamed.khair@qobouli.com"}
            </p>
          </section>
        </div>
      </div>
